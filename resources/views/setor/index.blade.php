                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('setor.daftarpengepul') }}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg"></i> Setor Sampah</a>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($setor as $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> {{ $item->pengepul->nama }}</td>
                                                            <td> {{ $item->sampah->nama_sampah}}</td>
                                                            <td> {{ $item->jumlah_sampah }}</td>
                                                            <td>Rp.{{ $item->sampah->harga_dasar}}</td>
                                                            <td>Rp.{{ $item->jumlah_sampah *  $item->sampah->harga_dasar  }}</td>
                                                            <td>
