...
<head>
  ...
  <title>{{$title}} - {{config('master.aplikasi.nama')}}</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{config('master.aplikasi.logo')}}">
  <link href="{{config('master.aplikasi.logo')}}" rel="shortcut icon">
  ...
  {{-- Select2 --}}
  <link href="{{asset('frontend/assets/vendor/select2/dist/css/select2.css')}}" rel="stylesheet">
...
{{-- 
  ...
  <script src="{{asset('frontend/assets/vendor/select2/vendor/jquery-3.4.1.js')}}"></script>
  <script src="{{asset('frontend/assets/vendor/select2/dist/js/select2.full.js')}}"></script>
