              ...
              <div class="card mb-3 shadow ">
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <h5 class="card-title text-center pb-0 fs-4">BANK SAMPAH</h5>
                  ...
                  <form class="row g-3 needs-validation" action="{{route('login.post')}}" method="post" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="password" @error('password') is-invalid @enderror >
                      @error('password')
                      <div class="invalid-feedback">{{$message}}</div>
                      @enderror
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Belum Punya Akun? <a href="{{route('registrasi')}}">Daftar sekarang</a></p>
                    </div>
                  </form>
